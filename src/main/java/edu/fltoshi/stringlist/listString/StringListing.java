package edu.fltoshi.stringlist.listString;

import edu.fltoshi.stringlist.interfeic.StringList;

public class StringListing implements StringList {
    private String[] array;
    private int size;

    public StringListing(int capacity) {
        if (capacity <= 0) {
